...
useEffect(() => {
  function addClassname() {
    document.getElementById('card__img--alt').classList.toggle('food')
    }
  return addClassname()
}, [])
...
return (
    <article className='card' id='card__img--alt'>
        <div className='card__img'>
          <img src='https://imgaz.staticbg.com/thumb/large/oaupload/banggood/images/8B/F7/c0981454-3289-41d4-9638-88337b4600a0.jpg' alt='prueba' ></img>
        </div>
